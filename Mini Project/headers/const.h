...
#define ASK_CUST_PASS "Enter Customer password:\n"

#define ASK_EMP_ID "Enter Employee ID:\n"
#define ASK_EMP_UNAME "Enter Employee username:\n"
#define ASK_EMP_PASS "Enter Employee password:\n"
